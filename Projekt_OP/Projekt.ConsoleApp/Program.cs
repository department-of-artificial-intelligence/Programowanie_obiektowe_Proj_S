...
using Projekt.DATABASE.Logic;
using Projekt.Model;
using Projekt.Model.Interfaces;
using Projekt.Model.Logic;
using Projekt.Model.UI;
using System;
using System.Linq;
using System.Net;
...
//                _context.Cinemas.Add(kino);
            ...
            bool isRuning = true;
            ICinemaRepository cinemaRepository = new CinemaRepository(_context);
            IEmployeeRepository employeeRepository = new EmployeeRepository(_context);
            IFilmRepository filmRepository = new FilmRepository(_context);
                    ...
                    case 1:
                        ...
                        switch (choice1)
                        {
                            ...
                            case 3:
                                ...
                                var cinema1 = new Cinema(cinemaName1, address1);

                                cinemaRepository.Add(cinema1);
                                break;
                            //==============================================
                            //Case4 nie działa do poprawy
                            case 4:
                                Console.Clear();
                                int cinemaIDdoUsuniecia = view.GetIDInput("Podaj ID kina do usuniecia: ");
                                Cinema cinemaDoUsuniecia = cinemaRepository.GetByID(cinemaIDdoUsuniecia);
                                cinemaRepository.Remove(cinemaDoUsuniecia);
                                break;
                    ...
                    case 2:
                        ...
                        switch (choice2)
                        {
                            ...
                            case 3:
                                ...
                                string employeeName1 = view.GetInput("Imie pracownika: ");
                                string employeeLastName1 = view.GetInput("Nazwisko pracownika: ");
                                int cinemaIDEmployee = view.GetIDInput("ID kina do ktorego przypisac pracownika: ");
                                Cinema cinemaID1 = cinemaRepository.GetByID(cinemaIDEmployee);
                                var employee1 = new Employee(employeeName1, employeeLastName1, cinemaID1);
                    ...
                    case 3:
                        ...
                        switch (choice3)
                        {
                            ...
                            case 2:
                                ...
                                break;
                                //Dodaj pozostałe case do menu films !!!
                        }

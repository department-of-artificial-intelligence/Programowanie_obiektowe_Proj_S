...
{
    /// <inheritdoc />
    public partial class MigracjaJeden : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubjectTutor", x => new { x.SpecialtiesId, x.TutorsId });
                    table.ForeignKey(
                        name: "FK_SubjectTutor_Subjects_SpecialtiesId",
                        column: x => x.SpecialtiesId,
                        principalTable: "Subjects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SubjectTutor_Tutors_TutorsId",
                        column: x => x.TutorsId,
                        principalTable: "Tutors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);

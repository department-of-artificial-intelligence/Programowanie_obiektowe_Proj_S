...
//Venue v5 = new Venue() { Name = "Muzyczna Meta", City = "Częstochowa", Capacity = 100 };

//context.Venues.AddRange(v1, v2, v3, v4, v5);

//Artist a1 = new Artist() { Name = "Afroman", Genre = "Hip-Hop", Country = "Stany Zjednoczone" };
//Artist a2 = new Artist() { Name = "TOOL", Genre = "Rock Progresywny", Country = "Stany Zjednoczone" };
//Artist a3 = new Artist() { Name = "Meshuggah", Genre = "Metal", Country = "Szwecja" };
//Artist a4 = new Artist() { Name = "Foo Fighters", Genre = "Rock", Country = "Wielka Brytania" };
//Artist a5 = new Artist() { Name = "Michael Jackson", Genre = "Pop", Country = "Stany Zjednoczone" };

//context.Artists.AddRange(a1, a2, a3, a4, a5);

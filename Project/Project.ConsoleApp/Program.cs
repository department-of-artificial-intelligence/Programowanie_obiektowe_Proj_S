...
namespace RestaurantManagement.ConsoleApp
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Tworzenie restauracji i danych
            Address address1 = new Address("Polska", "30-001", "Kraków", "Krakowska 15");
            Address address2 = new Address("Polska", "20-001", "Warszawa", "Warszawska 10");
            Address address3 = new Address("Polska", "22-134", "Częstochowa", "Armii Krajowej 69");
            Address address4 = new Address("Polska", "42-021", "Wrocław", "Głowna 5");
            ...
            Restaurant restaurant2 = new Restaurant
            {
                ...
                ClosingHours = new TimeOnly(21, 0),

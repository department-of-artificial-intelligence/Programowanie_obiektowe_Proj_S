...
namespace Project.Tests.Models.Common
{
    public class BaseTests
    {
        ...
        [Fact]
        public void Base_Constructor_SetsProperties()
        {
            // Act
        ...
        [Fact]
        public void Base_ConstructorWithParameters_SetsProperties()
        {
            // Arrange
            var id = "test-id";
        ...
        [Fact]
        public void Base_MarkAsUpdated_MultipleTimes_UpdatesCorrectly()
        {
            // Arrange
            var entity = new TestEntity();

...
namespace Project.Tests.Entities
{
    ...
    {
        private class TestPerson : PersonEntity
        {
        ...
        [Fact]
        public void PersonEntity_Constructor_ValidData_SetsProperties()
        {
            // Arrange
            var firstName = "John";
            var lastName = "Doe";
        ...
        public void PersonEntity_InvalidData_ThrowsException(string firstName, string lastName,
        ...
        [Fact]
        public void PersonEntity_FutureBirthDate_ThrowsException()
        {
            // Arrange
        ...
        public void PersonEntity_NamesWithSpecialCharacters_Valid(string firstName, string lastName)
        {
            // Arrange
            var birthDate = new DateTime(1990, 1, 1);

...
namespace Project.Test
{
    public class OrderModelTests
    {
        ...
        public void OrderItem_Should_Throw_Exception_When_Quantity_Is_Invalid(int invalidQuantity)
        {
            ...
            var product = new Product("Słuchawki Bezprzewodowe", 199.00m, 30, ProductCategory.Audio);
        ...
        public void OrderItem_Should_Calculate_LineTotal_Correctly()
        {
            ...
            var product = new Product("Tablet Graficzny", 1100.00m, 20, ProductCategory.Computer);
            int quantity = 3;
        ...
        public void Order_AddProduct_Should_Merge_Items_When_Product_Exists()
        {
            ...
            {
                Name = "Test7 Store",
                PhoneNumber = "+48698332214",
                Address = new Address { City = "TestCity", Street = "TestStreet", ZipCode = "49-532", Country = "PL" }
            };
            ...
            var p7 = new Product("Laptop Biurowy 15", 2400.00m, 10, ProductCategory.Computer);
            var p8 = new Product("Tablet Graficzny", 1100.00m, 20 , ProductCategory.Computer);
            var p9 = new Product("Smartfon Galaxy S24", 3999.00m, 30,ProductCategory.Smartphone);
        ...
        public void Order_AddProduct_Should_Throw_Exception_When_Adding_Zero_Quantity()
        {
            ...
            var order = new Order(new Customer("A", "B", "+48111222333", "a@b.com"), new Address("A", "B", "37-111", "D"), store);
            var product = new Product("Test", 100m, 2, ProductCategory.Other);
        ...
        public void Order_Status_Flow_And_Restrictions()
        {
            ...
            {
                Name = "Test2 Store",
                PhoneNumber = "+486572395123",
                Address = new Address { City = "TestCity", Street = "TestStreet", ZipCode = "00-000", Country = "PL" }
            };

            var customer = new Customer("Jan", "Test", "+48111222333", "j@test.pl");
            var order = new Order(customer, new Address("A", "B", "00-000", "D"), store);
        ...
        public void Order_Should_Block_Shipping_When_Cancelled()
        {
            ...
            var order = new Order(new Customer("Jan", "K", "+48123456789", "e@m.pl"), new Address("U", "M", "99-999", "PL"), store);

            order.AddProduct(new Product("Szczoteczka soniczna", 120.00m, 20, ProductCategory.SmallAppliance),2);
        ...
        public void Order_TotalAmount_Should_Sum_All_Items()
        {
            ...
            {
                Name = "Test12 Store",
                PhoneNumber = "+48911632214",
                Address = new Address { City = "TestCity", Street = "TestStreet", ZipCode = "49-532", Country = "PL" }
            };



            var order = new Order(new Customer("A", "B", "+48111222333", "a@b.onet"), new Address("A", "B", "25-001", "D"), store4);

            order.AddProduct(new Product("Klawiatura mechaniczna", 450.00m, 5,ProductCategory.Accessory), 1); 
            order.AddProduct(new Product("Laptop Biurowy 15", 2400.00m, 5, ProductCategory.Computer), 4);  

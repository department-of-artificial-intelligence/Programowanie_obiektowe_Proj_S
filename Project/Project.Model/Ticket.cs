...
namespace Project.Models
{
    ...
    public class Ticket : Base
    {
        ...
        public Ticket(string reservationId, string cinemaId, string auditoriumId, string seanceId, string filmId, string seatId, decimal originalPrice, TicketType type) 
                     : base()
        {
        ...
        private static void ValidateTicketData(string reservationId, string cinemaId, string auditoriumId, string seanceId, string filmId, string seatId, decimal originalPrice)
        {
            if (string.IsNullOrWhiteSpace(reservationId)) throw new ArgumentException("Reservation ID is required", nameof(reservationId));
            ...
            if (originalPrice <= 0) throw new ArgumentException("Price must be greater than 0", nameof(originalPrice));
        }
